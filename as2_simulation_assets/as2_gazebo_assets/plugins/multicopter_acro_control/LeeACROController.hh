...
#ifndef GZ_SIM_SYSTEMS_MULTICOPTER_CONTROL_LEEACROCONTROLLER_HH_
#define GZ_SIM_SYSTEMS_MULTICOPTER_CONTROL_LEEACROCONTROLLER_HH_
...
/// controller
struct LeeACROControllerParameters
{
...
class LeeACROController
{
  /// \brief Factory function to create LeeACROController objects
  ...
  /// pointer to an instance of LeeACROController

public:
  static std::unique_ptr<LeeACROController> MakeController(
  ...
  /// velocities
  /// \param[in] _command ACRO command as reference
