 ...
 *
 */
#ifndef GZ_SIM_SYSTEMS_MULTICOPTERACROCONTROL_HH_
...
/// AttitudeGain (roll, pitch, yaw): Proportional gain on ACRO. This
...
public:
  MulticopterACROControl() = default;
...
private:
  std::unique_ptr<multicopter_control::LeeACROController>
  ACROController;
...
private:
  std::optional<msgs::Quaternion> acroMsg;
