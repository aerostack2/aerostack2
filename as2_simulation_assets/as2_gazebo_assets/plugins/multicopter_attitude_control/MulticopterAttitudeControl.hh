...
public:
  MulticopterAttitudeControl() = default;
...
private:
  void OnQuat(const msgs::Quaternion & _msg);
...
private:
  std::unique_ptr<multicopter_control::LeeAttitudeController>
  attitudeController;
...
private:
  std::optional<msgs::Quaternion> quatMsg;
