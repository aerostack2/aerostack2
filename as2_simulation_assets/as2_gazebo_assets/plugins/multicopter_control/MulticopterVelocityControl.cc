...
//////////////////////////////////////////////////
void MulticopterVelocityControl::Configure(
  ...
  EventManager & /*_eventMgr*/)
{
  ...
  this->node.Subscribe(
    enableTopic, &MulticopterVelocityControl::OnEnable,
    this);
  ...
  EntityComponentManager & _ecm)
{
  ...
  this->velocityController->CalculateRotorVelocities(
    *frameData, cmdVel,
...
GZ_ADD_PLUGIN_ALIAS(
  MulticopterVelocityControl,
  "gz::sim::systems::MulticopterVelocityControlAlt")
