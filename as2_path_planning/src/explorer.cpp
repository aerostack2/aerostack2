  ...
  hover_handler_(this)
{
  ...
  debug_point_sub_ =
    ...
    "/clicked_point", 10,
    std::bind(
      &Explorer::clickedPointCallback, this,
      std::placeholders::_1),
    options);
  ...
  start_explore_srv_ = this->create_service<std_srvs::srv::SetBool>(
    "start_exploration",
    std::bind(
      &Explorer::startExplorationCbk, this, std::placeholders::_1,
      std::placeholders::_2),
    rmw_qos_profile_services_default, cbk_group_);

  rotate_srv_ = this->create_service<std_srvs::srv::SetBool>(
    "rotate_in_place",
    std::bind(
      &Explorer::rotateCbk, this, std::placeholders::_1,
      std::placeholders::_2),
    rmw_qos_profile_services_default, cbk_group_);
  ...
  uint8_t yaw_mode)
{
  ...
  send_goal_options.feedback_callback =
    std::bind(
    &Explorer::navigationFeedbackCbk, this, std::placeholders::_1,
    std::placeholders::_2);
